...
import WebAppTestingImg from "../assets/images/QualityAssurance/webAppTesting.svg";
import MobileAppTestingImg from "../assets/images/QualityAssurance/mobileAppTesting.svg";
import GameTestingImg from "../assets/images/QualityAssurance/gameTesting.svg";
import DesktopTestingImg from "../assets/images/QualityAssurance/desktopTesting.svg";
import CloudTestingImg from "../assets/images/QualityAssurance/cloudTesting.svg";
  ...
  return (
    <div>
      ...
      <div className="Dev QualityAss">
          ...
          <div className="col-lg-10 col-md-11 mx-auto">
            <div className="row heroBannerInner">
              <div className="col-lg-6">
                <div className="cnt">
                  <h1>
                    <span>QA Solutions &</span> Software Testing
                  </h1>
                  <p>
                    Deliver Quality assured Software with our 100% test
                    coverage.
                  </p>
                </div>
              </div>
        ...
        {/* classified service  */}
        <section className="software-quality">
          <div className="col-lg-10 col-md-11 mx-auto">
            <div className="top">
              <h2>
                Our Software Quality Assurance services are further classified
                as
              </h2>
            </div>
              ...
              <div className="row m-0">
                ...
                <div className="col-lg-6">
                  <div className="cnt mb-4 mb-lg-0">
                    ...
                    <p>
                      ...
                      enhance the quality and performance of the software. The
                      steps comprise Unit testing to complete regression testing
                      for accelerating the software quality.
                    </p>
                  </div>
                </div>
                {/* 2 */}
                <div className="col-lg-6">
                  <div className="cnt">
                    <h4>QA Automation</h4>
                    <p>
                      To back your Business Objectives Whitelabel’s test
                      Automation service brings you strategy alignment. Our
                      Automation Methodology is well regulated to Agile and
                      DevOps domain enhancing the software development cycle
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mainHeading">
          <h3 className="mb-3f">Providing unparalleled QA Solutions</h3>
          <p>
            Deploying software in the fittest of its form takes a lot of
          ...
          >
            <a
              href="/"
              className="btn-custom text-decoration-none mx-auto btn-size d-inline-block mt-4"
            >
              Contact Us
            </a>
          </Link> */}
        ...
        <div className="col-lg-10 col-md-11 mx-auto mainltorsec">
          <div className="top text-center">
            <h3>Our Top-notch Quality Assurance services</h3>
            <p>
              We implement the most effective and zero-error software testing to
              ensure the apps and software that walk out of our door are at
          ...
          <div className="">
            {QualityAppPageItemToDisplay.map((element) => {
              return (
                <div className="row serviceQa" key={element.id}>
                  <div className="col-lg-6">
                    <div className="serviceCnt">
                      ...
                      <div className="testing">
                        <p>
                          <span> {element.testingType1}</span>
                        </p>
                        <p>
                          <span>{element.testingType2}</span>
                        </p>
                        <p>
                          <span>{element.testingType3}</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="serviceImg">{element.Imgurl}</div>
                  </div>
                </div>
              );
            })}
        ...
        {/* Qa & Solution  */}
        <section className="our-qa">
          <div className="col-lg-10 col-md-11 mx-auto">
            <div className="top">
              <h3>Our QA and Software Testing Solutions</h3>
            </div>
            <div className="row m-0">
