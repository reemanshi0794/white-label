...
export default () => {
  return (
    <div className="min-h-screen text-secondary-500 p-8 overflow-hidden">
      ...
      <MainFeature1 subheading={<span className="uppercase tracking-wider text-sm">Our Vision</span>} heading="We aim to disrupt the design space." buttonRounded={false} primaryButtonText="Contact Us" imageSrc="https://images.unsplash.com/3/doctype-hi-res.jpg?ixlib=rb-1.2.1&auto=format&fit=crop&w=768&q=80" textOnLeft={false} />
      <Features
        subheading={<span className="uppercase tracking-wider text-sm">Our Values</span>}
