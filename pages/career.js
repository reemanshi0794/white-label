...
const CareerPage = ({
  ...
  return (
    <div id="career">
      ...
      <Header />
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 max-w-screen-xl mx-auto pt-48 px-8 lg:px-24">
        <div className="flex justify-center md:justify-start items-center text-center lg:text-left">
      ...
      <div className="max-w-screen-xl mx-auto md:py-8">
        ...
        <div className="md:mt-10 grid grid-cols-1 md:grid-cols-4 max-w-screen-lg mx-auto">
          {cards.map((card, i) => (
            <div key={i}>
              <a
