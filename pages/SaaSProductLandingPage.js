...
const SaaSProductLandingPage = ({
  ...
  return (
    <>
      ...
      <Footer />
      {show && (
        <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 bg-[#56565699] z-50 p-4 w-full md:inset-0 h-screen md:h-full justify-center items-center flex">
