  ...
  return (
    <AnimationRevealPage>
      ...
      <Features
        ...
        heading={
          <>
            We have Amazing <span className="text-primary-500">Service.</span>
          </>
        }
      />
      <MainFeature
      ...
      <FeatureWithSteps
        ...
        heading={
          <>
            Easy to <span className="text-primary-500">Get Started.</span>
          </>
        }
        textOnLeft={false}
      ...
      <MainFeature2
        ...
        heading={
          <>
            ...
            <span className="text-primary-500">Principles.</span>
          </>
        }
      ...
      <Pricing
        ...
        heading={
          <>
            Reasonable & Flexible{" "}
            <span className="text-primary-500">Plans.</span>
          </>
        }
        plans={[
          {
      ...
      <Testimonial
        ...
        heading={
          <>
            Our Clients <span className="text-primary-500">Love Us.</span>
          </>
        }
        testimonials={[
          {
      ...
      <FAQ
        ...
        heading={
          <>
            You have <span className="text-primary-500">Questions ?</span>
          </>
        }
        faqs={[
          {
