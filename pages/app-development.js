      ...
      <div className="relative">
        <div className="flex flex-col lg:flex-row lg:items-center max-w-screen-xl mx-auto pb-20 pt-32 md:pb-24 md:pt-32">
          <div className="relative lg:w-5/12 text-center max-w-xs md:max-w-lg  mx-auto lg:max-w-none lg:text-left">
            ...
            <p className="my-4 text-base xl:text-lg">
              People have the idea that apps are just for business. Let us stop
              you there. Mobile apps are meant for all domains. We just do not
              build apps for business, but for domains with a variety of
              purposes. We offer mobile app development services for brands,
              Diverse organizations, individuals, startups, businesses and more.
              A team of mobile app developers who are well-equipped with
              futuristic technical skills works behind every app that leaves our
              doors. We ensure reliability, scalability and compactness in all
              the apps that are developed at White Label
            </p>
          </div>
          <div className="relative mt-12 lg:mt-0 flex-1 flex flex-col justify-center lg:self-end">
            <div className="flex justify-center lg:justify-end items-center">
