...
const Link = styled.a`
  ${tw`w-56 p-3 sm:p-4 text-sm sm:text-base font-bold uppercase tracking-wider rounded-full inline-flex justify-center items-center mt-6 first:mt-0 sm:mt-0 sm:ml-8 first:ml-0 bg-gray-100 hocus:bg-gray-300 text-gray-900 hocus:text-gray-900 shadow hover:shadow-lg   focus:outline-none transition duration-300`}
  img {
      ...
      <Content>
        <Row>
          <TextContainer>
            ...
            <LinksContainer>
              <Link href={link1Url}>
                <img src={link1IconSrc.src} alt="" />
                <span>{link1Text}</span>
              </Link>
              <Link href={link2Url}>
                <img src={link2IconSrc.src} alt="" />
                <span>{link2Text}</span>
              </Link>
            </LinksContainer>
          </TextContainer>
          <ImageContainer>
            <img src={imageSrc.src} alt="" tw="w-64" />
          </ImageContainer>
        </Row>
