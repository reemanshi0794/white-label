...
export default ({
  ...
  subheading = "fcsdf",
  description = "Whiten App Solutions present you with the most exquisite digital services that let you stand out from the crowd.",
}) => {
  /*
  ...
  const defaultCards = [
    {
      ...
      description:
        "With thorough learning of your business, we create apps from scratch that are designed to retain your customers and increase sales 4X times.",
    },
    {
      imageSrc: SupportIconImage,
      title: "Enterprise Softwares",
      description:
        "Leverage our years of experience in building and scaling software that uplifts your business infrastructure to meet the dynamic market demands.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Launch your Online stores in global markets with our most reliable eCommerce apps and websites. From design to migration of eCommerce platforms with seamless integration and Zero Downtime.",
    },
    {
      imageSrc: FastIconImage,
      title: "Web Development",
      description:
        "Our unparalleled Web development services bring you the Top performing websites to companies of any size, suiting your organization’s needs.",
    },
    {
