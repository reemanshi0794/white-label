      ...
      <div className="max-w-screen-xl mx-auto py-20 lg:py-24">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="w-full max-w-md mx-auto md:max-w-none md:mx-0 md:w-5/12 xl:w-6/12 flex-shrink-0 relative">
            <img src={OurClient.src} imageBorder={imageBorder} imageShadow={imageShadow} imageRounded={imageRounded} />
            {/* <ImageDemo /> */}
          </div>
          <div className="w-full max-w-md mx-auto md:max-w-none md:mx-0 md:w-7/12 xl:w-6/12 mt-16 md:mt-0 pl-16" textOnLeft={textOnLeft}>
            ...
            <p className="mt-6 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-secondary-100">{description}</p>
            <Slider className="w-full mt-10 text-center md:text-left" arrows={false} ref={setSliderRef}>
                ...
                <div className="outline-none h-full flex! flex-col" key={index}>
                  ...
                  <div className="mt-auto flex justify-between items-center flex-col sm:flex-row">
                    ...
                    <div className="flex mt-8 sm:mt-0">
                      <button className="mx-3 p-4 rounded-full transition duration-300 bg-gray-200 hover:bg-gray-300 text-primary-500 hover:text-primary-700 focus:outline-none focus:shadow-outline" onClick={sliderRef?.slickPrev}>
                        <ArrowLeftIcon className="w-4 h-4 stroke-3" />
                      </button>
                      <div className="divider" />
                      <button className="mx-3 p-4 rounded-full transition duration-300 bg-gray-200 hover:bg-gray-300 text-primary-500 hover:text-primary-700 focus:outline-none focus:shadow-outline" onClick={sliderRef?.slickNext}>
