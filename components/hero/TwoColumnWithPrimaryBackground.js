...
import HeaderBase, {LogoLink as LogoLinkBase, NavLink as NavLinkBase, NavLinks, PrimaryLink as PrimaryLinkBase} from '../headers/light.js';
...
export default ({heading = 'High Performant Servers tailored to your needs', description = 'Our cloud provisions the best servers, with fast SSD, powerful Xeon Processors, whenever you need it. Oh, and we have 99.9% SLA', primaryButtonText = 'Start Your 15 Day Free Trial', primaryButtonUrl = '#', imageSrc = serverIllustrationImageSrc}) => {
  const logoLink = (
    <LogoLink href="/">
